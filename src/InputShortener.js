  ...
  return (
    <div className="inputContainer">
      ...
      <form onSubmit={handleSubmit}>
        <input type="url" value={originalUrl} onChange={(e) => setOriginalUrl(e.target.value)} placeholder='Enter URL'/>
        <button type="submit" onClick={handleClick}>Submit</button> 
      </form>
      <br></br>
      <label className="shortText"><h3>Your Short URL:    {showComponent && <MyComponent />}</h3></label>
